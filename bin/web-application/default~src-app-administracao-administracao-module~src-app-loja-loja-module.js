(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~src-app-administracao-administracao-module~src-app-loja-loja-module"],{
...
/***/ "./src/app/loja/servicos/usuario.service.ts":
/*!**************************************************!*\
  !*** ./src/app/loja/servicos/usuario.service.ts ***!
  \**************************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _util_end_points_util__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../util/end-points.util */ "./src/app/loja/util/end-points.util.ts");
...
var UsuarioService = /** @class */ (function () {
     ...
     */
    UsuarioService.prototype.buscarPorEmail = function (email, token) {
        return this.httpClient.get(_util_end_points_util__WEBPACK_IMPORTED_MODULE_2__["URL_CONTROLE_VENDAS"] + "/usuarios/search/findByEmail/" + email + "?access_token=" + token);
    };
    UsuarioService.prototype.validarPorEmail = function (email, senha) {
        var headersObject = new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpHeaders"]().
            set('Content-Type', 'application/x-www-form-urlencoded').
            set('Authorization', _util_end_points_util__WEBPACK_IMPORTED_MODULE_2__["BASIC_AUTHORIZATION"]);
        var body = new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpParams"]()
            .set('username', email)
            .set('password', senha)
            .set('grant_type', _util_end_points_util__WEBPACK_IMPORTED_MODULE_2__["GRANT_TYPE_AUTHORIZATION"]);
        return this.httpClient.post(_util_end_points_util__WEBPACK_IMPORTED_MODULE_2__["URL_AUTENTICACAO"] + "/oauth/token", body.toString(), { headers: headersObject });
    };
...
/***/ "./src/app/loja/util/end-points.util.ts":
/*!**********************************************!*\
  !*** ./src/app/loja/util/end-points.util.ts ***!
  \**********************************************/
/*! exports provided: URL_AUTENTICACAO, URL_CONTROLE_VENDAS, URL_CATEGORIAS, URL_PRODUTOS, URL_ENDERECOS, URL_PEDIDOS, BASIC_AUTHORIZATION, GRANT_TYPE_AUTHORIZATION */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "URL_AUTENTICACAO", function() { return URL_AUTENTICACAO; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "URL_CONTROLE_VENDAS", function() { return URL_CONTROLE_VENDAS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "URL_CATEGORIAS", function() { return URL_CATEGORIAS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "URL_PRODUTOS", function() { return URL_PRODUTOS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "URL_ENDERECOS", function() { return URL_ENDERECOS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "URL_PEDIDOS", function() { return URL_PEDIDOS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BASIC_AUTHORIZATION", function() { return BASIC_AUTHORIZATION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GRANT_TYPE_AUTHORIZATION", function() { return GRANT_TYPE_AUTHORIZATION; });
var URL_AUTENTICACAO = '/api/autenticacao';
var URL_CONTROLE_VENDAS = '/api/controle-vendas';
var URL_CATEGORIAS = '/api/controle-vendas/categorias';
var URL_PRODUTOS = '/api/controle-vendas/produtos';
var URL_ENDERECOS = '/api/controle-vendas/enderecos';
var URL_PEDIDOS = '/api/controle-vendas/pedidos';
var BASIC_AUTHORIZATION = 'Basic ZHJvcHNoaXBwaW5nLWNsaWVudDpkcm9wc2hpcHBpbmctc2VjcmV0';
var GRANT_TYPE_AUTHORIZATION = 'password';


/***/ })

}]);
//# sourceMappingURL=default~src-app-administracao-administracao-module~src-app-loja-loja-module.js.map